...
// Import motion-observer as an ES Module
import('motion-observer').then(module => {
    const MotionObserver = module.default;
    
    // Initialize motion detection
    const motion = new MotionObserver({
        width: 1920,
        height: 1080,
        threshold: MOTION_THRESHOLD,
        areaThreshold: MOTION_AREA_THRESHOLD,
        interval: 1000 // Check for motion every second
    });
